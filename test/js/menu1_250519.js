$(document).ready(function(){
    ...
    */
    ...
    /* 
        ...
        3. 다른메뉴에 마우스를 오버하면 이전에 오버했던 메뉴는 아웃됨 (over 클래스 삭제)
            removeClass
    ...
    */
    ...
    $('header .gnb .gnb_wrap ul.depth1 > li').on('mouseenter focusin', function(){
        if(device_status == "pc"){ //pc일 때만 실행
            ...
            /*  이전에 마우스를 오버했던 li에서 over를 삭제해야하는데
    ...
    /* 
        ...
        1. 닫혀있는 메뉴를 클릭하면 열림
            header .gnb .gnb_wrap ul.depth1 > li.open 에 open 클래스가 추가
        ...
        4. 모바일에서 1차메뉴를 클릭하면 1차메뉴를 a에 입력되어 있는 링크주소로 이동
            메뉴를 안열고..
    ...
    $('header .gnb .gnb_wrap ul.depth1 > li > a').on('click', function(e){
        if(device_status == "mobile"){
            ...
            if(depth1_open == true){ //열려있을 경우에 / == -> 비교 연산자 , 같을 때 쓴다 / 
    ...
    /* 
        ...
        --- > header .gnb .gnb_open를 클릭하면 header에 menu_open 클래스 추가
