$(document).ready(function(){
    ...
    let slogan_leng = slogan_obj.length // 숫자 길이
    ...
    let dark = $('.life')
    let dark_top //슬로건이 위에서 부터 떨어진 거리
    ...
    function photo_resize(){
        ...
        photo_end = photo_top + photo.height() - (win_h * 0.8)
    ...
    function slogan_ani(){
        slogan_top = slogan.offset().top // 위에서 떨어진 값
